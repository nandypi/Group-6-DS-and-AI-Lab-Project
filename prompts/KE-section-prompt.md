...
The input is ONE logical section of an official Infosys document that is longer than 10 pages. The input is NOT the complete document.
...
4. If some field is not applicable, return null or []. Information absent from this section may appear elsewhere in the document.
...
10. The title and summaries should describe only the supplied section. Do not claim to summarize the complete document.
...
- detailed_summary:
  A concise factual summary (100-250 words) describing the important information contained in this section. Do not include opinions or speculation, and do not claim that it summarizes the complete document.
