...
Generate realistic questions that an investor or analyst may ask based on the document.

Determine the number of questions from the document's materiality, topic breadth, and information density—not its page count.

Use these limits:
- Non-material document: 2–4 questions
- Material document covering a narrow event: 4–6 questions
- Material and information-dense document: 6–10 questions
- Never return more than 10 questions

Stop generating questions when additional questions would be repetitive, trivial, overly specific, or not clearly answerable from the document.

Questions should:
- cover the most important facts and implications
- represent different user intents where possible
- be answerable primarily from the document
- use natural wording that a real user might enter
- include company or counterparty names when needed for standalone clarity
- include relevant dates or periods when ambiguity is possible

Prefer questions about:
- what happened
- financial value or scale
- strategic significance
- counterparties
- timelines
- expected business impact
- leadership or regulatory implications
- key risks or conditions

Do not generate:
- duplicate or lightly reworded questions
- questions about boilerplate or submission mechanics
- speculative questions that the document cannot answer
- excessively broad questions such as "Tell me everything about Infosys"
- questions whose answers depend mainly on external information
