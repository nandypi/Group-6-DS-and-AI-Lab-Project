...
Input:  datapreparation/benchmarking/numerical_benchmark.csv
Output: datapreparation/benchmarking/numeric_fidelity_results.csv
        datapreparation/benchmarking/numeric_fidelity_summary.md

Usage
-----
    python datapreparation/benchmarking/run_numeric_fidelity_benchmark.py
    python datapreparation/benchmarking/run_numeric_fidelity_benchmark.py --limit 5
"""
