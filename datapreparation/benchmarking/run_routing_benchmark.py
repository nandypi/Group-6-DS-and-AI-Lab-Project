...
Output: datapreparation/benchmarking/routing_benchmark_results.csv
        datapreparation/benchmarking/routing_benchmark_summary.md

Usage
-----
    python datapreparation/benchmarking/run_routing_benchmark.py
    python datapreparation/benchmarking/run_routing_benchmark.py --descriptive-limit 20
"""
