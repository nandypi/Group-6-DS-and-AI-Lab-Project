...
section_description: "This section contains part of the auditor's key audit matter discussion on revenue recognition for fixed-price contracts and the related audit procedures. It also describes management and Board responsibilities for interim consolidated financial statements."
topics:
  - Key audit matters
  - Revenue recognition
...
sample_queries:
  - What judgments were identified in revenue recognition for fixed-price maintenance contracts?
  - How is fixed-price maintenance revenue recognized under different service patterns?
  - What audit procedures were performed for estimates of costs or efforts to complete fixed-price contracts?
  - Why was the estimate of total efforts or costs to complete fixed-price contracts considered a key audit matter?
  - What are the Board of Directors' responsibilities for interim consolidated financial statements?
  - Who is responsible for assessing going concern for entities included in the Group?
---
