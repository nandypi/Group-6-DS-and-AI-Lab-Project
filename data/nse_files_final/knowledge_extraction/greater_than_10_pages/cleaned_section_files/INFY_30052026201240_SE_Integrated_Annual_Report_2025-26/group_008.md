...
section_description: "This section contains parts of Infosys' Board's report covering cybersecurity, internal financial controls, statutory disclosures, audit reports and auditors, CSR, ESG, BRSR, other affirmations, and acknowledgements. It also introduces Annexure I on salient features of financial statements of subsidiaries, associate companies, and joint ventures."
topics:
...
sample_queries:
  ...
  - "What amounts and shares were transferred to the Investor Education and Protection Fund during the year?"
  - "What confirmations are included in the Directors' responsibility statement?"
  - "Who was Infosys' statutory auditor for fiscal 2026, and what future auditor appointment was proposed?"
  - "What areas does Infosys focus on through its CSR initiatives?"
  - "What is the role of the ESG Committee and when was it constituted?"
  - "What BRSR assurance requirements and assurance provider are described in this section?"
  - "What statutory affirmations did Infosys make for the year ended March 31, 2026?"
---
...
The details of the resultant benefits arising out of shares already transferred to the IEPF, year-wise amounts of unclaimed / unencashed dividends lying in the unpaid dividend accounts up to the year, and the corresponding shares, which are liable to be transferred, are provided in the Corporate governance report. Details of shares / dividend transferred to the IEPF can also be obtained from the Company.

Members are requested to claim the dividend(s), which have remained unclaimed/unpaid, by sending a written request to the Company or to the Company's Registrar and Transfer Agent, KFin Technologies Ltd.
...
The Company's CSR Policy is available on its website.
...
In addition to this, we also publish a comprehensive ESG Report annually, based on the GRI standard 2021. The ESG Report is available. Deloitte Haskins & Sells LLP has also assured certain select indicators of the ESG report designed based on GRI standards.
