...
source_section_ids:
  ...
  - "Infosys_21102025214121_SEfiling_Earningscalltranscript_q2__008"
---
---
section_title: "Satish H. C."
section_description: "This section contains management remarks and Q&A from an Infosys earnings call, focused on enterprise AI strategy, deal activity, delivery model changes, utilization, guidance, and client demand. It includes discussion of Infosys Topaz, forward-deployed engineers, AI partnerships, H-1B-related delivery changes, large deals, Versent, furloughs, hiring, and revenue guidance."
topics:
  - Enterprise AI strategy
  - Infosys Topaz and AI offerings
  - Forward-deployed engineers
  - Large deals and vendor consolidation
  - Delivery mix and visa changes
  - Revenue guidance and margins
  - Versent joint venture
  - Hiring and utilization
sample_queries:
  - "What AI capabilities and offerings did Infosys describe in this earnings call section?"
  - "How many generative AI, AI, and agentic AI projects did Infosys say it was delivering?"
  - "What role do forward-deployed engineers play in Infosys' AI strategy?"
  - "How did management describe the margin profile of large deals?"
  - "What did Infosys say about H-1B visa changes and the future delivery model?"
  - "What comments did management make about utilization and subcontractor usage?"
  - "What was said about Versent revenue, regulatory approvals, and guidance?"
  - "What guidance range did Infosys provide for full-year revenue growth?"
---
...
We deliver value through two strategic frameworks, services.ai and client.ai. In services.ai, we build a foundation for better business services for our clients by accelerating IT capabilities and operations, both our own and our clients.
...
The challenge of extracting value from enterprise AI investments and pilots continues to be the biggest priority for global enterprises. We have expertise in delivering that through five key levers.
...
I wanted to ask on deal activity and kind of average sizes. Can you comment on what you are seeing in some of the smaller deal activity? Any changes there versus the prior quarter? And then just on the signings, so the TCV has been healthy now for two quarters. Can you comment on just how ACV levels in new work that you are booking may be trending?
...
This is Salil. So, there, we see two types of things for AI. One, growth opportunities, where we see clients are starting to look at leveraging AI, whether it is in their sales function, their marketing function, how they can drive growth from it. And the second, as you point out, is more productivity or efficiency for different processes and activities within their company.
