...
source_section_ids:
  - "INFY_30052026200807_SE_Integrated_Annual_Report_2025-26__056"
...
section_description: "This section contains Business Responsibility and Sustainability Reporting disclosures on principle-wise performance, including governance policies, training coverage, fines and penalties, conflict of interest controls, accounts payable, related-party openness, sustainable sourcing, and product responsibility."
topics:
...
sample_queries:
  - "What training and awareness programmes were held for the Board, KMPs, employees, and workers in Fiscal 2026?"
  - "What monetary penalties or fines were disclosed for Infosys Limited during the financial year?"
  - "Does Infosys have an anti-corruption or anti-bribery policy?"
  - "How many complaints were received regarding conflicts of interest of Directors or KMPs?"
  - "What was the number of days of accounts payable in Fiscal 2026 and Fiscal 2025?"
  - "What percentage of value chain partners were covered by awareness programmes?"
  - "What processes does Infosys have to manage conflicts of interest involving Board members?"
...
| Monetary action | NGRBC Principle | Nameof the regulatory/ enforcement agencies/ judicial institutions | Amount (In INR) | Brief of the Case | Has an appeal been preferred? (Yes/No) |
|---|---|---|---|---|---|
...
| Non-Monetary action | NGRBC Principle | Nameof the regulatory / enforcement agencies / judicial institutions | Brief of the Case | Has an appeal been preferred? (Yes/No) |
|---|---|---|---|---|
| Imprisonment | - | - | - | - |
| Punishment | - | - | - | - |
