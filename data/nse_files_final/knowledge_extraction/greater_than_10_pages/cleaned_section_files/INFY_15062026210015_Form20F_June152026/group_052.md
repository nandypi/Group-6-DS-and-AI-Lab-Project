...
section_description: "This section describes manager responsibilities under the Infosys Code of Conduct and covers respect in the workplace, anti-discrimination, workplace safety, anti-corruption, gifts, charitable contributions, third-party dealings, insider trading, export controls, import regulations, and anti-boycott laws."
topics:
  - Manager ethics responsibilities
  ...
  - Insider trading and company shares
  - Export controls and anti-boycott laws
sample_queries:
  - What responsibilities do managers have under the Infosys Code of Conduct?
  - What conduct does Infosys prohibit under its discrimination and harassment policy?
  - What are Infosys employees told to do when offering gifts or entertainment to customers or government officials?
  - What red flags should employees watch for when transacting with third parties?
  - What is Unpublished Price Sensitive Information and why does it matter for trading Infosys securities?
  - What does the Code say about short selling Infosys securities?
  - What should employees consider in relation to export controls and import regulations?
  - How does Infosys define bribes, kickbacks, and facilitation payments?
---
...
A kickback is a form of corruption that involves two parties agreeing that a portion of their sales or profits will be kicked back, or given back, to the purchasing party in exchange for making the deal.
...
Acceptance of gifts is not encouraged. Please refer to the Anti-Bribery and Anti-Corruption Policy before accepting any gifts or entertainment. Reach out to the Office of Integrity & Compliance in case of any query.
...
We have a strict diligence process for charitable contributions. Reach out to the Office of Integrity & Compliance to understand the diligence we need to follow.
...
For more details, read the Company's Insider Trading Policy. All questions regarding the Company's Insider Trading Policy should be directed to the insider trading contact.
...
- While we should familiarize ourselves with Infosys' export control policies, we should understand that the export rules are complex, and enlist the assistance of the Office of Integrity & Compliance at an early stage.
