...
estimated_tokens: 5388
source_section_ids:
  - "INFY_15062026210015_Form20F_June152026__088"
  - "INFY_15062026210015_Form20F_June152026__089"
---
---
section_title: "Penalty for Insider Trading"
section_description: "This section sets out provisions of the Infosys insider trading code covering penalties, disclosure requirements, internal controls, miscellaneous compliance obligations, review and amendment, and related annexure forms. It includes pre-trading approval, undertaking, transaction disclosure, and SEBI Form A templates."
topics:
  ...
  - Pre-trading approval forms
  - SEBI disclosure forms
sample_queries:
  - "What disciplinary actions may apply for violating the insider trading code?"
  - "What disclosures are required when a person becomes a director, KMP, promoter, or member of the promoter group?"
  - "When must a Designated Person disclose trades exceeding INR 10,00,000?"
  - "What internal controls must the Company maintain to prevent insider trading?"
  - "What records must the Compliance Officer maintain and for how long?"
  - "What details are required in the application for pre-trading approval?"
  - "What undertaking must accompany an application for pre-clearance?"
  - "What information is required in Form A under SEBI insider trading regulations?"
---
...
b. Every Designated Person shall disclose details like Permanent Account Number or any other identifier authorized by law, names of educational institutions from which they have graduated and names of their past employers for the following: (i) Immediate Relative; (ii) persons with whom such Designated Person(s) share a material financial relationship; (iii) phone and mobile numbers which are used by them.
...
vi. The Company has adopted the amended Infosys Code on Fair Disclosures and Investor Relations to regulate the Company's practices and procedures for fair disclosure of UPSI and comply with the SEC's Regulations.
...
I, __________ being a designated person of the company as per the code for Trading in the securities of the Company, am desirous of trading in shares of the Company as mentioned in my application dated __________ pre-clearance transaction.
...
i. have not bought / sold / subscribed any securities of the Company; or

ii. have bought / sold / subscribed to securities as mentioned below on (date) (strike out whichever is not applicable).
...
| Name, PAN, Address contact, CIN/DIN | Category of Person (Promoter or Member of promoter group/KMP/Directors/immediate relative to/others etc.) | Date of appointment of Director/KMP OR Date of becoming Promoter/member of the promoter group | Securities held at the time of becoming Promoter or member of the promoter group/appointment of Director/KMP - Type of security (For eg: Shares, Warrants, Convertible-debentures etc.) | Securities held at the time of becoming Promoter or member of the promoter group/appointment of Director/KMP - No. |
|---|---|---|---|---|
| nos. | | | | |
...
| Open Interest of the Future contracts held at the time of becoming Promoter/member of the promoter group/appointment of Director/KMP - Contract specifications | Open Interest of the Future contracts held at the time of becoming Promoter/member of the promoter group/appointment of Director/KMP - Number of units (contracts * lot size) | Open Interest of the Future contracts held at the time of becoming Promoter/member of the promoter group/appointment of Director/KMP - Notional value in Rupee terms | Open Interest of the Option Contracts held at the time of becoming Promoter/member of the promoter group/appointment of Director/KMP - Contract specifications | Open Interest of the Option Contracts held at the time of becoming Promoter/member of the promoter group/appointment of Director/KMP - Number of units (contracts * lot size) | Open Interest of the Option Contracts held at the time of becoming Promoter/member of the promoter group/appointment of Director/KMP - Notional value in Rupee terms |
|---|---|---|---|---|---|
| | | | | | |
