...
section_description: "This section contains risk factors related to Infosys' markets, clients, investments, cost structure, workforce, contracts, operations, regulatory compliance, and ADSs. It discusses macroeconomic conditions, immigration laws, sanctions, client concentration, pandemics, climate change, and the company's ability to provide end-to-end business solutions."
topics:
  - Market and client risks
  - Macroeconomic and geopolitical uncertainty
  - Immigration and visa regulation
  - Client concentration and credit risk
  - Climate change impacts
  - Sanctions and regulatory exposure
  - Service offerings and technology changes
  - Operational and compliance risks
sample_queries:
  - "What risks does Infosys identify related to client technology spending and macroeconomic uncertainty?"
  - "How much of Infosys' fiscal 2026 revenue came from North America, Europe, and the Rest of the World excluding India?"
  - "What immigration law and visa-related risks does Infosys describe?"
  - "What risks could arise if Infosys loses a major client or large contract?"
  - "How could climate change affect Infosys' clients and reputation?"
  - "What sanctions-related risks does Infosys face when working with clients in various geographies?"
  - "How could pandemics or contagious disease outbreaks disrupt Infosys' business?"
  - "Why could Infosys' inability to provide end-to-end business solutions harm its business?"
---
