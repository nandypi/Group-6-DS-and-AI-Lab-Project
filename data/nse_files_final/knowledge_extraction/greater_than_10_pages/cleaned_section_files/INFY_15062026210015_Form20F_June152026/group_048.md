...
section_description: This section contains Infosys Limited's code of conduct for prohibition of insider trading, including background, definitions, restrictions on communication and trading of unpublished price sensitive information, trading window rules, pre-clearance requirements, additional trading restrictions, and trading plan provisions.
topics:
  - Insider trading code
  - Designated Persons and Insiders
  ...
  - Trading Plans
sample_queries:
  - What persons are treated as Designated Persons under Infosys Limited's insider trading code?
  - What information is classified as unpublished price sensitive information under the code?
  ...
  - What restrictions apply to Contra Trades by Designated Persons?
  - When can UPSI be communicated under the code?
  - What exceptions apply to the prohibition on insider trading?
...
7. 'Designated Person' shall consist of:
   ...
   vi. Any other person designated on the basis of their functional role where such function would provide access to UPSI.
...
10. 'Immediate Relative' means a spouse of a person, and includes parent, sibling, and child of such person or of the spouse, if they are either dependent financially on such person, or consult such person in taking decisions relating to Trading in Securities.
...
22. 'Unpublished Price Sensitive Information' ('UPSI') means any information, relating to a Company or its Securities, directly or indirectly, that is not generally available information which upon becoming generally available, is likely to materially affect the price of the Securities and shall, ordinarily including but not restricted to, information relating to the following:
   ...
   xii. Initiation of forensic audit (by whatever name called) by company or any other entity for detecting misstatement in financials, misappropriation / siphoning or diversion of funds and receipt of final forensic audit report;
...
4. The restriction in 3(1) above may not apply to:
   ...
   b. a transaction carried out through block deal window mechanism between persons who were in possession of UPSI without being in breach of this Code and both parties made a conscious and informed trade decision.

   c. a transaction carried out pursuant to a statutory or regulatory obligation;

   d. a transaction undertaken pursuant to exercise of stock options and the exercise price is predetermined with applicable regulations; and
