...
section_description: "This section contains Board confirmations and regulatory conditions for the Infosys Limited buyback, along with details of the public announcement and the buyback terms. It includes the buyback size, offer price, eligibility information, ADS holder participation conditions, and promoter and promoter group shareholding."
topics:
  - Board confirmations
...
sample_queries:
  - What conditions did the Board confirm for the Infosys buyback?
  - What is the maximum number of equity shares proposed to be bought back?
  ...
  - What was the aggregate promoter and promoter group shareholding as of the Public Announcement date?
---
...
5.3 The Company will publish further notices or corrigenda, if any, in the above mentioned newspapers. A copy of the Public Announcement dated [●], 2025, published on [●], 2025 is available on the website of SEBI, Company, NSE, BSE, Registrar to the Buyback and the Manager to the Buyback.
