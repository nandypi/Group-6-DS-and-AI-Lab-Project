...
section_description: "This section contains Infosys' principle-wise business responsibility and sustainability disclosures, including governance, ethics, training, fines and penalties, conflict of interest, accounts payable, openness of business, value chain awareness, sustainable sourcing, R&D, capex, waste, and EPR applicability."
topics:
  ...
  - "R&D, capex, waste, and EPR"
sample_queries:
  - "What training and awareness programmes covered the Board, KMPs, and employees during Fiscal 2026?"
  - "What fines or penalties were disclosed under Principle 1 for Fiscal 2026?"
  - "Does Infosys have an anti-corruption or anti-bribery policy?"
  - "How many days of accounts payable did Infosys report for Fiscal 2026 and Fiscal 2025?"
  - "What information is disclosed about concentration of purchases, sales, and related party transactions?"
  - "What awareness programmes were conducted for value chain partners?"
  - "What processes does Infosys describe for managing Board conflicts of interest?"
  - "What percentage of R&D and capex investments related to improving environmental and social impacts?"
---
...
| Action | NGRBC Principle | Name of the regulatory / enforcement agencies / judicial institutions | Amount (In INR) | Brief of the Case | Has an appeal been preferred? (Yes/No) |
|---|---|---|---|---|---|
...
| Action | NGRBC Principle | Name of the regulatory / enforcement agencies / judicial institutions | Brief of the Case | Has an appeal been preferred? (Yes/No) |
|---|---|---|---|---|
| Imprisonment | - | - | - | - |
| Punishment | - | - | - | - |
...
|  | Fiscal 2026 Number | Fiscal 2026 Remarks | Fiscal 2025 Number | Fiscal 2025 Remarks |
|---|---|---|---|---|
...
| Total number of awareness programs held | Topics / principles covered under the training (1) | %age of value chain partners covered (by value of business done with such partners) under the awareness programs (2) |
|---|---|---:|
