...
section_description: This section covers Infosys' cybersecurity posture, internal financial controls, annual return, secretarial standards, stock exchange listings, IEPF transfers, directors' responsibilities, auditors, CSR, ESG, BRSR, statutory disclosures, and acknowledgements. It also includes information on audit reports, auditor appointments, fraud reporting, CSR policy, ESG Vision 2030, and other regulatory affirmations for fiscal 2026.
topics:
  ...
  - Regulatory disclosures and affirmations
sample_queries:
  - What cybersecurity certifications and attestations does Infosys mention for fiscal 2026?
  - What did Infosys transfer to the Investor Education and Protection Fund during the year?
  - What confirmations are included in the directors' responsibility statement?
  - Which statutory auditor is proposed to replace Deloitte Haskins & Sells LLP, and when?
  - What CSR focus areas does Infosys describe in this section?
  - What is Infosys' ESG Vision 2030 focused on?
  - What assurance requirements are described for BRSR Core KPIs?
  - What regulatory affirmations did Infosys make for the year ended March 31, 2026?
---
