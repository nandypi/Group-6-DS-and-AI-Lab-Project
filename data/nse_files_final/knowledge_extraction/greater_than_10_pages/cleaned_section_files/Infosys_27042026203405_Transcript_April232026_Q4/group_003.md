...
group_id: "Infosys_27042026203405_Transcript_April232026_Q4__group_003"
source_section_count: 2
estimated_tokens: 4497
source_section_ids:
  - "Infosys_27042026203405_Transcript_April232026_Q4__005"
  - "Infosys_27042026203405_Transcript_April232026_Q4__006"
---
---
section_title: "Infosys Limited Q4 FY26 Earnings Conference Call"
section_description: "This section contains part of Infosys' Q4 FY26 media interaction and the opening remarks from its Q4 FY26 earnings conference call. It covers AI strategy, acquisitions, FY26 performance, FY27 guidance, vertical commentary, margins, large deals, capital allocation, and the beginning of analyst Q&A."
topics:
  - Q4 FY26 earnings
  - FY27 revenue and margin guidance
  - AI strategy and client work
  - Acquisitions
  - Large deals
  ...
  - Analyst Q&A
sample_queries:
  - "What did Infosys say about the contribution of acquisitions to FY27 growth guidance?"
  - "How is Infosys' Board overseeing AI initiatives?"
  - "What examples did Infosys give of AI work with clients such as Ralph Lauren, Hertz, and BP?"
  - "What were Infosys' FY26 revenue growth, large deal TCV, and operating margin figures?"
  - "What FY27 revenue and operating margin guidance did Infosys provide?"
  - "How did Infosys describe demand conditions across Financial Services, Manufacturing, EURS, Retail, and Communications?"
  - "What were the main headwinds and tailwinds for Q4 operating margins?"
  - "What assumptions did Infosys include in its FY27 guidance?"
---

## Salil Parekh

And in terms of the people, just on Q4, a little bit the seasonality is what Jayesh was saying. Every year, we have this scenario where Q4 or Q3 is a little bit like the second half is a little bit less than the first half. It is just the nature of our activity.
...
Both of those are getting developed quite rapidly and the skilling has gone on. I think just over 90% of people are now getting skilled on different types of AI platforms.
...
Good evening. Three questions.

The first one, multiple brokerages have pointed out that the three acquisitions you all announced last fiscal would contribute around 200 to 225 basis points of growth in FY27. Considering that has not been factored into the guidance, if we factor the contribution from those acquisitions, that translates to the fastest growth for the company in at least three years.

How do you see this going forward? If you can help me understand the growth trajectory in that sense a little bit more, considering your peers have called out AI-led deflation and multiple clients pulling back their tech spending?

Second, on Board oversight of AI. How is Infosys' Board actually overseeing the way AI is used for clients as well as internally? One of your peers is giving incentives to executives for passing on productivity gains to clients and many other such measures. What is Infosys doing in that sense?

Lastly, if you can throw a little more light on the kind of acquisitions you will be looking at going ahead.

## Salil Parekh

On the first one, Jayesh shared that the one acquisition that is closed, we have already put that in. I think the estimates are meaning, when we announce the acquisition, the revenue number is known and so on. So what you are describing, I am guessing, is based on that analysis. It is just a function of which date it will close.

Sometimes it may take a week, it may take a month, it may take two months. It is not going to take five years. So it will get sorted. We are not trying to give guidance assuming it will come in. But as soon as it comes in, we will obviously put that in and do it.

I think the maths what you are saying on a full-year basis is approximately correct. So that is not a problem on that at all. And our growth trajectory, I know what you said with some other things in the industry, but we see this growth for this year. Even without acquisitions there is growth, and with it, and we will continue to see that.
...
The Board, in fact as you notice we were a bit late today coming, so we just had an update. We did the full update with a lot more detail internally and there was a lot of discussion. So the Board is very active in our AI work, looking at it, and actually Nandan himself is very active because he has got a very good vision on where the AI is going and also helping. A lot of the Topaz Fabric that we have done, he is working to give us the ideas, which of course we are building, but he is the visionary person on that one.

Acquisitions, we will continue to do acquisitions. There is a good pipeline. We did two which came together by coincidence, but in general we will continue to do acquisitions in areas like healthcare, which we did, where we feel we can expand nicely and the market is good.

## Jas Bardia

Just one last question, if I can just squeeze it in. What kind of contracts are you seeing and how have they evolved over the last three to four years from fixed price to outcome based? If you can just shed some more light on that. Also wonderful to hear of Mr. Nilekani, but if you can just shed some more light on what are some of the means that the Board is having a tab on whatever AI goes out and the kind of AI work that Infosys does?

## Salil Parekh

There is no specific thing like that on what the Board is doing because they are very involved in it and Nandan himself is there on it.

On the contracts, we are continuing to see the type of contracting that we were doing in the past. There are a lot of discussions now that, because AI is transformative, can we look at something which is outcome based.

We have built with our delivery leadership, with our sales leadership, good models or templates for how those are to be done, and there are active discussions as it is still early times. Over time there may be more of that, but there are discussions on that. A lot of the contracts are also on the way they were being done in the past as well.
...
12. Free cash flow adjusted for the Labor Code and income tax refunds stood at $3.5 bn for FY and $882 mn for Q4. Adjusted free cash as a percentage of net profit continued to be well above 100% at 106% for FY26 and 111% for Q4.
13. We had strong large deal wins in financial year with a TCV of $15 bn with 55% net new. Large deal pipeline continues to remain strong. Our $50 mn plus clients increased by 3 and $100 mn plus clients also increased by 3, $400 mn by 2 in FY26.
...
Hi Yogesh, this is Jayesh here. At the lower end of the guidance we have assumed higher deterioration in the environment and at the upper end, we have assumed improved environment, similar to what we have done in the last year as well.

In terms of margin walk, I did give you a broad margin walk, but largely we have invested all the benefit that we got from Rupee as well as from Maximus back into the business, whether it is sales and marketing costs which has gone up by 40 basis points on a full-year basis, the AI talent and the AI partnerships etc. So, I think all of that has been absorbed in the margin in the financial year.
