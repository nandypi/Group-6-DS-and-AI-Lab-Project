...
section_description: "This section contains accounting policies and financial tables for revenue from operations, other income, foreign currency translation, government grants, and expenses. It also describes trade receivables, contract balances, employee benefit plans, provident fund, superannuation, and compensated absences."
topics:
  - Revenue recognition
...
sample_queries:
  - "How does the Company recognize revenue from time-and-material, unit of work, and fixed-price contracts?"
  - "What was the revenue from software services for the three months and nine months ended December 31, 2025?"
  - "How are unbilled revenue and unearned revenue classified on the Balance Sheet?"
  - "What were the major components of other income for the three months ended December 31, 2025?"
  - "How does the Company account for foreign currency transactions and translations?"
  - "What expenses were reported under employee benefit expenses for the nine months ended December 31, 2025?"
  - "What are the Company’s accounting policies for gratuity, provident fund, superannuation, and compensated absences?"
---
