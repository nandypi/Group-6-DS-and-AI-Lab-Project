...
group_id: "Infosys_18112025182523_SE_letter_LoF_18112025__group_011"
source_section_count: 2
estimated_tokens: 4473
source_section_ids:
...
section_description: "This section describes statutory approvals, regulatory conditions, registrar submission requirements, and the process and methodology for Infosys Limited's 2025 buyback. It includes buyback size, price, eligibility, record date, entitlement ratios, category-wise acceptance methodology, and fractional entitlement rules."
topics:
  - Statutory approvals
  ...
  - Basis of acceptance
sample_queries:
  - "What statutory approvals are required for the Infosys 2025 buyback?"
  - "What obligations apply to non-resident shareholders participating in the buyback?"
  - "What is the buyback price, size, and maximum number of equity shares proposed to be bought back?"
  - "What record date was fixed for determining buyback entitlement?"
  - "How are Small Shareholders defined for this buyback?"
  - "What are the buyback entitlement ratios for the Reserved Category and General Category?"
  - "How are fractional entitlements handled in the buyback?"
  - "What is the order of acceptance for shares tendered in the Reserved Category and General Category?"
---
...
- 22.12 Based on the above analysis and in accordance with Regulation 6 of the Buyback Regulations, 1,50,00,000 Equity Shares have been reserved for the Small Shareholders ("Reserved Portion") and accordingly, the General Category for all other Eligible Shareholders shall consist of 8,50,00,000 Equity Shares ("General Portion").
