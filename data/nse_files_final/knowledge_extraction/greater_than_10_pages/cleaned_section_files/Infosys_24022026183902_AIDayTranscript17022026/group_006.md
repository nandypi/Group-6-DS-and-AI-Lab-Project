...
source_section_ids:
  - "Infosys_24022026183902_AIDayTranscript17022026__010"
  - "Infosys_24022026183902_AIDayTranscript17022026__011"
  - "Infosys_24022026183902_AIDayTranscript17022026__012"
---
---
section_title: "Moderator"
section_description: "This section contains a Q&A discussion from an Infosys AI Day transcript, covering AI investments, margin implications, pricing models, headcount, services intensity, and future growth opportunities. Speakers discuss AI revenue contribution, Topaz, agents, training, utilization, client value capture, market opportunities, and post-AI demand."
topics:
  - AI investments and margins
  - AI revenue and growth runway
  - Pricing models and non-linearity
  - Talent reskilling and headcount
  - AI agents and services intensity
  - Market opportunities and client adoption
  - Post-AI software demand
sample_queries:
  - "What did Infosys say about maintaining margins while investing in AI capabilities?"
  - "How did Infosys describe the current and future revenue contribution from AI?"
  - "What pricing models are emerging for AI and Topaz-related projects?"
  - "How does Infosys expect to use freshers and specialized talent in AI projects?"
  - "What did Infosys say about build versus buy and the addressable market for services?"
  - "How might Infosys capture more value from AI-driven productivity and client savings?"
  - "What was said about small language models, mid-market customers, and growth markets?"
  - "What did Infosys say about net headcount growth as AI services pick up?"
---

## Jonathan Lee

Hi. This is Jonathan Lee from Guggenheim. Thanks for hosting us today. A lot to be excited about here around the AI opportunity. Can you help us understand the level of investment necessary there to reskill and hire laterally to meet the opportunity in hand? And how should we think about the impact to margins there ex potential currency benefit?

## Salil Parekh

So there, I will start off, Jayesh may have some things to add. One of the things we have been very clear about is we want to make sure we invest in this AI capability build-out, AI Topaz Fabric and platform and other tools that we have built to invest in scaling that up, scaling up the go-to-market and scaling up what we need to do in terms of training.
...
Yes. That is right. From where Infosys is today, as we navigate this journey, let us say over a period of five years, you know, if you could put that in context?
...
Hi. This is Aditya from UBS. Just a couple of questions. So you guys have spoken a lot about Topaz and it is good to see, I think it is moved beyond, you know, those pilot use cases to more enterprisewide use cases. But if you could also touch a little bit on how we should think about the pricing models there? Because for example, in the walkthroughs we learned that some of the projects that needed huge team sizes have now, you know, been compressed to just use of the platform and maybe a very lean team.
...
And second is a question related to the evolution of pricing model that you talked about. If it creates room for non-linearity, what is the headroom that you get from investment point of view to accelerate your journey in AI? Thank you.
...
Yes. Once the enterprise clients enter the post AI adoption where most of the application modernize, data layer has been created, cloud migration has happened. In that phase the investor worries the terminal growth rates could be much lower because of the applications, data could have been modernized.
...
So the post-AI world in my mind is not a static world where everything is done, it is a world where there are large enterprises starting to use agents in many areas, having very strong platforms, using for example Topaz Fabric as a capability but also building new functions, new features, managing things. It is much like what we have today where there are new things happening even on platforms, older platforms, which let us call it are somewhat stable today in terms of they are implemented.

But there is always new work that people are looking for. But that is the nature of the economic growth where there is always new features, functions that tech is driving and more tech across the enterprise which can give you different areas to work on. So my sense is in the post-AI, of course the transition is very exciting with all the work we will do, but there is even more work, because there will be more and more things that will be going on in that post-AI era.
