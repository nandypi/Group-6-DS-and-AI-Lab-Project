...
---
---
section_title: "Shaji Mathew"
section_description: "This section contains remarks from Infosys executives on AI workforce transformation, brand strategy, AI offerings, partnerships, and a question-and-answer discussion from Infosys Limited Investor AI Day 2026. It includes discussion of talent operating models, career architecture, AI training, enterprise AI brand positioning, market opportunities, revenue compression, deal timelines, ERP migration, and sector growth visibility."
topics:
  - "AI workforce transformation"
  - "Talent operating model"
  - "Career architecture"
  - "Enterprise AI brand strategy"
  - "Infosys Topaz and AI offerings"
  - "AI market opportunity and compression"
  - "Client trust and partnerships"
  - "Investor Q&A"
sample_queries:
  - "What are the three pillars of Infosys' AI transformation strategy?"
  - "How is Infosys developing deep AI engineering and domain expertise internally?"
  - "What does Infosys mean by an ambidextrous organization in the AI context?"
  - "How is Infosys changing its career architecture for human plus AI work?"
  - "What brand initiatives did Infosys describe for building enterprise AI awareness?"
  - "What did Infosys say about the $300 billion to $400 billion AI opportunity and compression?"
  - "Has Infosys seen large deal timelines shrink because of AI prototypes or ROI visibility?"
  - "What did Infosys say about ERP migration timelines and modernization?"
---

## Shaji Mathew

Good afternoon, everyone. Through the day today, we heard how AI is transforming the industry, how it is reshaping the work all of us do. That necessitates a complete transformation in our workforce as well. I believe in the saying that it is not the organizations which have got the best technology that will win, but those are the organizations which prepare their workforce to embrace that technology that are going to win.
...
The assessment center of excellence that we have does the assessment on a 5-point scale all the way up to AI-led simulations. And we also know that, in a new AI world, the skill is the new currency, not necessarily the jobs and the roles. So the CQ, which is our Capability Quotient, which really assesses the skill of the employee has got four dimensions. It assesses people on technology, it assesses people on domain, looks at people on the foundational skills as well as on societal skills. It is a comprehensive framework that we have to assess people on their skill.
...
Good afternoon, everyone. I know it has been an intense day of learning. And first of all, thank you for really taking the time and spending this entire day with us. Now I am quite pleased to actually talk to you about the role of the brand in the larger AI journey that we are on. As most of you know, mindshare leads market share. Now that is something we have heard as an adage.
...
What you are seeing on your right is a ranking by Brand Finance, a leading brand consultancy firm based out of London. They have seen Infosys as the fastest-growing brand in its category around the world for the last six years. To your left is another highlight of Kantar BrandZ Top 100 brands results and Infosys for several years in a row is now being rated as a Top 100 brand, not just in the IT industry, but across categories.
