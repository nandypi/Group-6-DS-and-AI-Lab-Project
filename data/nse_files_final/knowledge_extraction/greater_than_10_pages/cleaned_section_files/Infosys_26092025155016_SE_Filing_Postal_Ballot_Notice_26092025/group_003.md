...
---
---
section_title: "SPECIAL NOTE FOR ADS HOLDERS - ACTION REQUIRED TO PARTICIPATE IN THE BUYBACK"
section_description: "This section provides information about ADS holder participation in the buyback, the buyback completion timeline, statutory limits on the buyback size, shareholding of promoters, directors and key managerial personnel, and recent equity share, ADR, RSU and option transactions."
topics:
  - ADS holder participation
  - Buyback completion timeline
  - Buyback size compliance
  - Promoter and promoter group shareholding
  - Director and key managerial personnel shareholding
  - ADR holdings
  - RSU and option holdings
  - Recent share and incentive transactions
sample_queries:
  - "How can ADS holders participate in the buyback?"
  - "What is the proposed time limit for completing the buyback?"
  - "What are the standalone and consolidated paid-up equity capital and free reserves as of June 30, 2025?"
  - "What is the maximum permissible buyback amount under Section 68 and Regulation 4(i)?"
  - "How many equity shares are held by the promoters and promoter group?"
  - "What equity shares are held by Infosys directors and key managerial personnel?"
  - "What RSUs and options are held by directors and key managerial personnel?"
  - "What equity share, ADR, RSU and option transactions occurred before the Postal Ballot Notice?"
---
...
Based on the above, the Buyback Offer Size, i.e., ₹18,000 crore (Rupees Eighteen Thousand Crore only), is less than 25% of the total paid-up capital and free reserves of the Company, based on both standalone and consolidated financial statements of the Company.
...
### b. The aggregate shareholding of the directors of the Promoters, as on the date of this Postal Ballot Notice, where the promoter is a Company:
...
| 3. | Inderpreet Sawhney | Chief Legal Officer and Chief Compliance Officer | ADR RSUs | 1,82,327 | - |
...
| Sr. No. | Name | Aggregate no. of RSUs and Options purchased or sold | Nature of Transaction | Maximum price per ADR | Date of maximum price | Minimum price per ADR | Date of minimum price |
|---|---|---:|---|---:|---|---:|---|
| 1. | Inderpreet Sawhney | 31,520 | Exercise of ADR RSUs | ₹5.00 | August 27, 2025 | ₹5.00 | August 27, 2025 |
