...
section_description: This section contains Infosys Limited's postal ballot notice seeking member approval for a proposed buyback of equity shares. It describes the buyback terms, e-voting schedule, eligibility, ADS holder participation, regulatory conditions, and the proposed special resolution.
topics:
  ...
  - Special resolution
sample_queries:
  - What special resolution is Infosys seeking shareholder approval for?
  - What are the proposed buyback price and buyback offer size?
  - When does the e-voting period start and end?
