...
source_section_ids:
  - "Infosys_29052026201312_Infosys_Integrated_Annual_Report_2025-26__102__part_002"
  - "Infosys_29052026201312_Infosys_Integrated_Annual_Report_2025-26__103"
---
---
section_title: Independent Auditor's Report
section_description: This section contains the independent auditor's report on Infosys Limited's consolidated financial statements for the year ended March 31, 2026. It includes the audit opinion, basis for opinion, and key audit matters related to revenue recognition.
topics:
...
sample_queries:
  - What opinion did the auditor give on Infosys Limited's consolidated financial statements for the year ended March 31, 2026?
  - What standards did the auditor follow when auditing the consolidated financial statements?
  - Why was revenue recognition identified as a key audit matter?
  - What judgments are involved in revenue recognition for customer contracts?
  - How does the Group recognize fixed-price maintenance revenue?
  - What audit procedures were performed for fixed-price contracts using the percentage-of-completion method?
---
...
|  | - Obtained and read contract documents for each selection, including master service agreements, and other documents that were part of the agreement.<br>- Identified significant terms and deliverables in the contract to assess management's conclusions regarding the (i) identification of distinct performance obligations (ii) whether the Group is acting as a principal or an agent and (iii) whether fixed-price maintenance revenue is recognized on a straight-line basis or using the percentage of completion method |
