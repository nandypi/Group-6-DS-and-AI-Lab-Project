...
group_id: "Infosys_29052026201312_Infosys_Integrated_Annual_Report_2025-26__group_030"
...
section_description: "This section contains Infosys' Business Responsibility and Sustainability Reporting disclosures on NGRBC policy coverage, management processes, governance oversight, ESG commitments, and review mechanisms. It includes policy mappings, standards adopted, ESG Committee details, and information on review and external assessment of policies."
topics:
  - "NGRBC policy disclosures"
  - "ESG Vision 2030"
  - "Business responsibility governance"
  - "ESG Committee oversight"
  - "Policy implementation authorities"
  - "Review of NGRBC principles"
  - "External policy assessment"
sample_queries:
  - "Which Infosys policies are mapped to each NGRBC principle?"
  - "Has Infosys translated its NGRBC-related policies into procedures?"
  - "What standards and certifications has Infosys adopted for each NGRBC principle?"
  - "What progress does Infosys report against its ESG Vision 2030 goals?"
  - "Who is responsible for implementation and oversight of Infosys' business responsibility policies?"
  - "Which directors are members of the ESG Committee of the Board?"
  - "How often does Infosys review performance against NGRBC-related policies?"
  - "Has Infosys carried out an independent external assessment of its policies?"
---
