...
section_description: This section covers Infosys' cybersecurity posture, internal financial controls, statutory disclosures, audit reports, auditors, CSR, ESG, BRSR, and other Board's report affirmations for fiscal 2026. It also includes acknowledgements and the heading for Annexure I on subsidiaries, associate companies, and joint ventures.
topics:
  ...
  - ESG and BRSR disclosures
  - Other statutory disclosures
sample_queries:
  - What cybersecurity certifications and attestations does Infosys mention for fiscal 2026?
  - What amounts and shares were transferred to the Investor Education and Protection Fund?
  - What confirmations are included in the directors' responsibility statement?
  - What do the audit reports say about qualifications, reservations, or adverse remarks?
  - Who are Infosys' statutory and secretarial auditors, and what are their terms?
  - What CSR focus areas does Infosys describe in this section?
  - What does Infosys say about its ESG Vision 2030 and ESG Committee?
  - What other statutory affirmations did Infosys make for the year ended March 31, 2026?
---
...
In accordance with the Act, the annual return in the prescribed format is available.
...
Members are requested to claim the dividend(s), which have remained unclaimed/unpaid, by sending a written request to the Company or to the Company's Registrar and Transfer Agent, KFin Technologies Ltd. Members can find the details of the Nodal Officer appointed by the Company under the provisions of the IEPF and the details of unclaimed dividend and shares.
...
The Company's CSR Policy is available.
...
In addition to this, we also publish a comprehensive ESG Report annually, based on the GRI standard 2021. Deloitte Haskins & Sells LLP has also assured certain select indicators of the ESG report designed based on GRI standards.
