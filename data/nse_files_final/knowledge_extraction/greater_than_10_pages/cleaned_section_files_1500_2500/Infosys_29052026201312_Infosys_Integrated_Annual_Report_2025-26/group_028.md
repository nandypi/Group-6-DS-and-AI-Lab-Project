...
---
---
section_title: "(f) Excess amount for set-off"
section_description: "CSR disclosures covering excess CSR expenditure, unspent CSR amounts from the preceding three financial years, and capital assets created or acquired through CSR spending during fiscal 2026."
topics:
  - CSR expenditure
  - Excess CSR amount
...
sample_queries:
  - "What was Infosys' total CSR spending during the financial year?"
  - "What amount was available for CSR set-off in succeeding financial years?"
  - "What were Infosys' unspent CSR amounts for the preceding three financial years?"
  ...
  - "What CSR spending supported the Universal Cornea Care Mission?"
  - "What was the CSR contribution to the Karnataka cybercrime investigation and training center?"
  - "What CSR spending was associated with Konappana Agrahara Metro station?"
  - "What environmental and farming initiatives were supported through CSR spending?"
  - "Which entities were registered owners or beneficiaries of the CSR-funded assets?"
  - "What CSR amounts had been spent in previous fiscal years on the listed projects?"
  - "What qualifications apply to the CSR capital asset amounts reported for fiscal 2026?"
---

## Note:

1. Includes a surplus of ` 0.40 crore generated and spent during the year.
2. The unspent amount will be transferred to the unspent CSR account within 30 days from the end of the financial year, in accordance with the Companies Act, 2013, read with the Companies (Corporate Social Responsibility Policy) Rules, 2014, as amended (`CSR Rules`).
...
| Sl. No. | Short particulars of the property or asset(s), including complete address and location | Pin code of the property or asset(s) | Date of creation | Amount of CSR amount spent (1) (in ` crore) | CSR Registration Number, if applicable | Name of registered owner | Registered address |
|---|---|---:|---|---:|---|---|---|
...
1. The above table includes assets that were completed in fiscal 2026.
2. Amount spent in fiscal 2026 does not indicate the complete value of the asset.
3. Details of CSR projects below ` 1 crore are available on the website: [CSR capital assets 2025-26](https://www.infosys.com/investors/reports-filings/documents/csr-capital-assets2025-26.pdf).
4. Amount spent in previous fiscal years:
   1. Medical equipment and software system for Universal Cornea Care: ` 18.60 crore.
   2. Setting up the center for cybercrime investigation, training, and research to accelerate and strengthen Karnataka's cybercrime investigation momentum through capacity-building, research, and development: ` 4.37 crore.
   3. Construction of Konappana Agrahara Metro station, Bengaluru: ` 182.39 crore.
   4. Providing medical equipment to Post Graduate Institute of Medical Education & Research (PGIMER): ` 51.45 crore.
   5. Construction of a skill development training center and other facilities, including hostel rooms, classrooms, labs, workshop rooms, and a large dining area: ` 10.31 crore.
