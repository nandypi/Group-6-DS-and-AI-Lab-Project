...
---
---
section_title: Consolidated Net Assets and Comprehensive Income by Entity
section_description: Entity-level net assets, profit or loss, other comprehensive income, and total comprehensive income, followed by consolidation adjustments, controlled trusts, non-controlling interests, and total consolidated amounts. Amounts are presented in ₹ crore.
topics:
  - Entity-level net assets
...
sample_queries:
  ...
  - Which entities reported losses during the period?
  - What was In-tech GmbH’s share of profit or loss?
  - What were the net assets and profit or loss of The Missing Link Security Pty Ltd?
  - What was the subtotal of consolidated net assets?
  - What adjustment arose out of consolidation?
  - What were the amounts attributable to controlled trusts?
  - What were the non-controlling interests in net assets and total comprehensive income?
  - What were the total consolidated net assets and total comprehensive income?
---

# Consolidated Net Assets and Comprehensive Income by Entity

| Name of entity | Net assets as % of consolidated net assets | Net assets amount (₹ crore) | Share in profit or loss as % of consolidated profit or loss | Share in profit or loss amount (₹ crore) | Share in other comprehensive income as % of consolidated other comprehensive income | Share in other comprehensive income amount (₹ crore) | Share in total comprehensive income as % of consolidated total comprehensive income | Share in total comprehensive income amount (₹ crore) |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
