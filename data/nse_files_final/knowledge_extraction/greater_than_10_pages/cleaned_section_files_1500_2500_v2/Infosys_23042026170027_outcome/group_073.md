...
section_description: The section lists Infosys group entities, their countries of incorporation or operation, and two ownership-percentage columns as reported in the source. It includes entities across technology services, consulting, business process management, financial services, life sciences, automotive engineering, and other businesses.
topics:
  - Subsidiary entities
  - Geographic presence
  ...
  - Financial services
  - Acquired and affiliated entities
sample_queries:
  - Which Infosys entities are listed in the United States?
  - Which subsidiaries are located in India?
  - What ownership percentages are reported for Infosys Compaz Pte. Ltd.?
  - What ownership percentages are reported for HIPUS Co., Ltd.?
  - Which entities are listed in the Netherlands?
  - Which subsidiaries are associated with Panaya?
  - Which entities are associated with GuideVision?
  - Which subsidiaries are associated with Stater?
  - Which entities are associated with BASE life science?
  - Which companies are associated with in-tech?
  - Which entities are listed in Australia?
  - Which subsidiaries have ownership reported at 75%?
  - Which entities have missing or dash ownership values?
  - Which Infosys entities are listed in Germany?
  - Which subsidiaries are associated with WongDoody?
---

| Entity | Country | Percentage 1 | Percentage 2 |
|---|---|---:|---:|
