---
section_title: Subsidiary Ownership and Geographic Presence
section_description: This section lists Infosys subsidiaries, their countries of incorporation or operation, and two ownership percentage columns as reported in the source. It includes entities across Europe, Asia-Pacific, the Americas, the Middle East, and India.
topics:
  ...
  - Recent subsidiary additions
sample_queries:
  - Which Infosys subsidiaries are located in Finland, Sweden, Norway, Denmark, and Slovakia?
  - What ownership percentages are reported for the Fluido entities?
  - Which Stater entities are listed in the Netherlands, Belgium, and Germany?
  - Which WongDoody subsidiaries are listed in Germany, China, Taiwan, and Serbia?
  - Which BASE life science entities are listed, and where are they located?
  - Which in-tech entities are listed in Germany, Romania, Mexico, Spain, the United States, and China?
  - Which subsidiaries have a reported ownership percentage of 75%?
  - Which subsidiaries have a dash or blank in one of the ownership columns?
  - Which Infosys entities are listed in Oman, Saudi Arabia, Australia, and the United States?
  - Which The Missing Link entities are listed in Australia, the United Kingdom, and Canada?
---

| Entity | Country | Ownership column 1 | Ownership column 2 |
|---|---|---:|---:|
