...
section_description: The section lists Infosys subsidiaries, associated entities, countries of incorporation, and two reported ownership percentages. It includes entities across consulting, technology services, financial services, life sciences, automotive engineering, and other businesses.
topics:
  - Subsidiary entities
  - Geographic presence
...
sample_queries:
  - Which Infosys subsidiaries are incorporated in the United States?
  - What ownership percentages does Infosys hold in Infosys Compaz Pte. Ltd.?
  - Which entities are based in Germany?
  - Which subsidiaries are listed under the Stater group?
  - Which entities are associated with GuideVision?
  - Which Infosys entities operate in automotive engineering?
  - Which BASE life science entities are listed?
  - Which entities have a reported ownership percentage of 75%?
---

| Entity | Country | Ownership 1 | Ownership 2 |
|---|---|---:|---:|
