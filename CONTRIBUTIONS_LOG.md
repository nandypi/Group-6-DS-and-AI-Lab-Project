...
| **Akbar Ali** | Created test Streamlit and FastAPI applications and implemented a hybrid retrieval approach combining BM25 and ENN. Additionally, performed evaluations to assess the effectiveness and overall performance of the hybrid approach. |
