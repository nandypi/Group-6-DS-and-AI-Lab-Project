...
| **Shubhashish Biswas** | 
 Included data from Infosys IR, included scripts for data collection from Yt finance, reviewed data veracity and helped with chunking strategy formulation, reviewed readme and ppt |
